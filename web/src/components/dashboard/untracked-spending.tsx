...
import type { UntrackedCategorySpend } from "@/lib/hooks/use-dashboard";

interface Props {
  spending: UntrackedCategorySpend[];
}
 ...
 * listed by category; expenses with no category collapse into "Untracked".
 */
export function UntrackedSpendingCard({ spending }: Props) {
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
              {top.map((c) => {
                ...
                return (
                  <div
                    key={c.category_id ?? "__untracked__"}
